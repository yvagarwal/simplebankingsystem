...
public class Main {
    ...
    public static void main(String[] args) {
        ...
        Account yashsAccount = new Account("98745",0,"Yash","yash@xyz.com","985465412");

        yashsAccount.DepositMoney(50);
        yashsAccount.DepositMoney(150);

        yashsAccount.WithDrawMoney(100);
